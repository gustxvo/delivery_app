...
class _OrderPageState extends BaseState<OrderPage, OrderController> {
  ...
  int? paymentTypeId;
  final isPaymentTypeValid = ValueNotifier<bool>(true);
  ...
  void _showConfirmProductDialog(OrderConfirmDeleteProductState state) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title:
              Text('Deseja excluir o produto ${state.orderProduct.product.name}?'),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.of(context).pop();
                controller.cancelDelteProcess();
              },
              child: Text(
                'Cancelar',
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            BlocSelector<OrderController, OrderState, double>(
                              ...
                              builder: (context, totalOrderPrice) {
                                return Text(
                                  totalOrderPrice.currencyPtBr,
                                  style: context.textStyles.textExtraBold
                      ...
                      OrderField(
                        ...
                        validator: Validatorless.required('CPF inválido'),
                      ...
                      BlocSelector<OrderController, OrderState,
                        ...
                        builder: (context, paymentTypes) {
                          return ValueListenableBuilder(
                            valueListenable: isPaymentTypeValid,
                      ...
                      Padding(
                        ...
                        child: DeliveryButton(
                          ...
                          onPressed: () {
                            ...
                            final isPaymentTypeSelected = paymentTypeId != null;
                            isPaymentTypeValid.value = isPaymentTypeSelected;

                            if (isValid && isPaymentTypeSelected) {
